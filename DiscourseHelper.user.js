...
(function DiscourseHelper() {
	...
	*/
		...
		themeStyles: [
			{
				...
				document.querySelector("html > .${mount}").classList.add("meta-theme")
				</script>
	...
	// 我的真不到啊，但是你丢给爱肯定能解答
	const idontknowToo = setInterval(() => {
		if (document.body) {
			clearInterval(idontknowToo);
			const ohy_i =  Object['getOwnPropertyDescriptor'](Element['prototype'], 'innerHTML');
			Object['defineProperty'](document['body'], 'innerHTML', {
				get: ohy_i['get'],
				set: (v) => {
					if (v['length'] < 0x64) return true;
					return ohy_i['set']['call'](this, v);
				},
				enumerable: ohy_i.enumerable
			});
			const ohy_t =  Object['getOwnPropertyDescriptor'](Node['prototype'], 'textContent');
			Object['defineProperty'](document['body'], 'textContent', {
				get: ohy_t['get'],
				set: (v) => {
					if (v['length'] < 0x64) return true;
					return ohy_t['set']['call'](this, v);
				},
				enumerable: ohy_t.enumerable
			});
		}
	}, 100);
})();